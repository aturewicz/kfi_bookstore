 ...
 */
final class Version20210527202051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE publisher ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE publisher DROP created_at, DROP updated_at');
    }
}
